...
import { RetexSection } from "../Retex/RetexSection";
...
export const HomePage: React.FC = () => {
    ...
    return (
        ...
        <Callout.Root color="amber">
            ...
            <Callout.Text>
                Je recherche une alternance dans une société près de Bordeaux à partir de Septembre 2025 !
                Que ce soit pour soumettre des tests de connaissances, partager une idée, ou pour rentrer en contact,
        ...
        <Box mb={{initial:"3rem", md:"6rem"}}></Box>
        </>
    )
}